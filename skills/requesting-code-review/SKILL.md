...
Quick scan before dispatching the reviewer. Review across 5 axes:
...
- [ ] Clear, descriptive names for functions, variables, modules
- [ ] No over-complicated logic (nested conditionals, one-liners)
- [ ] Code reads like a specification

**3. Architecture** — Does it fit existing patterns?
- [ ] Follows project conventions and structure
- [ ] No leaked dependencies or circular imports
- [ ] Appropriate abstractions (not over-engineered, not under-engineered)

**4. Security** — Is the trust boundary maintained?
